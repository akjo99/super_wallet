...
public class NewBaseInforActivity extends BaseActivity {
    ...
    protected int getLayout() {
        return R.layout.activity_new_baseinfo;
    }
                ...
                .execute(new JsonCallBack() {
                    ...
                    public void onResponse(String json) {
                        ...
                        if ("200".equals(textTipsBean.getCode())) {
                            tvText4.setText(textTipsBean.getText().getText4().replace("\\n","\n"));
                            tvText4_1.setText(textTipsBean.getText().getText4_1().replace("\\n","\n"));
                        } else {
    ...
    private void getBaseInfo() {
        OkGo.post(Api.BASE_INFORMATION)
                    ...
                    public void onResponse(String json) {
                        ...
                        if ("200".equals(stepInfoBean.getCode())) {
                            ...
                            if ("FaceAuth".equals(nextStep)) {
                                Intent intent = new Intent(NewBaseInforActivity.this, CameraStepActivity.class);
                                startActivity(intent);
                            } else if ("IDAuth".equals(nextStep)) {
                                Intent intent = new Intent(NewBaseInforActivity.this, IDAuthActivity.class);
                                startActivity(intent);
                                finish();
                            } else if ("BasicInfo".equals(nextStep)) {
                                Intent intent = new Intent(NewBaseInforActivity.this, NewBaseInforActivity.class);
                                startActivity(intent);
                                finish();
                            } else if ("MountVerify".equals(nextStep)) {
                                Intent intent = new Intent(NewBaseInforActivity.this, AuthenticationActivity.class);
                                startActivity(intent);
                                finish();
                            } else if ("BindCard".equals(nextStep)) {
                                Intent intent = new Intent(NewBaseInforActivity.this, BankActivity.class);
                                startActivity(intent);
                                finish();
                            } else if ("PaymentSelect".equals(nextStep)) {
                                Intent intent = new Intent(NewBaseInforActivity.this, NewPayActivity.class);
                                startActivity(intent);
                                finish();
                            } else if ("Finish".equals(nextStep)) {
                                Intent intent = new Intent(NewBaseInforActivity.this, MainActivity.class);
                                startActivity(intent);
                                SPUtils.getInstance().put("is_vip", true);
                                finish();
                            }else if ("Wallet".equals(nextStep)){
                                Intent intent = new Intent(NewBaseInforActivity.this,WalletActivity.class);
                                startActivity(intent);
                                finish();
                            }
                        }
